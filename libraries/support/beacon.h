/*!
 * \file beacon.h
 * \brief Agent state-of-health beacon packet construction.
 * \ingroup cosmos_agent_messaging
 * \defgroup cosmos_beacon Beacon
 *
 * Provides functions to build the periodic state-of-health beacon packets
 * broadcast by every COSMOS agent. The beacon encodes a compact namespace
 * snapshot into a PacketComm payload so that any listening agent or ground
 * station can track node health without a full namespace exchange.
 */
