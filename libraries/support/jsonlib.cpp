...
int32_t update_target(Convert::locstruc source, targetstruc &target)
{
    ...
    // pos_set_utc is robust: source.utc is always valid regardless of which telemetry
    // frames are populated (unlike source.pos.selg.utc which may be 0 for ECI feeds).
