...
/*!
 * \file jsonlib.h
 * \brief COSMOS namespace serialization, deserialization, and live namespace management.
 * \ingroup cosmos_agent_namespace
 * \defgroup cosmos_jsonlib Namespace Library
 *
 * Implements the runtime COSMOS namespace: mapping JSON key strings to live
 * C++ variables, serialising/deserialising entire namespace snapshots, and
 * managing named values for inter-agent communication. Depends on jsondef.h
 * for type definitions and on the kernel JSON classes for parsing.
 */
