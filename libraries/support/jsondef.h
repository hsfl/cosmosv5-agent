...
/*!
 * \file jsondef.h
 * \brief COSMOS telemetry/command namespace: all struct definitions and JSON key mappings.
 * \ingroup cosmos_agent_namespace
 * \defgroup cosmos_jsondef Namespace Definition
 *
 * The authoritative definition of the COSMOS data namespace. Declares every
 * struct (cosmosstruc, nodestruc, agentstruc, device_*_struc, …) and the
 * corresponding JSON key strings used for serialisation. This is the largest
 * and most central header in COSMOS; virtually every agent and tool depends on
 * it.
 */
