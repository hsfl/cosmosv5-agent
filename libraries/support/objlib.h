/*!
 * \file objlib.h
 * \brief 3-D mesh and CAD object file I/O for spacecraft geometry.
 * \ingroup cosmos_agent_namespace
 * \defgroup cosmos_objlib Object
 *
 * Reads Wavefront OBJ and related 3-D mesh files that describe spacecraft
 * geometry used for solar-pressure, drag, and thermal modelling. Populates the
 * node_obj structure in the COSMOS namespace. Required when running
 * high-fidelity physics simulations that account for spacecraft shape.
 */
