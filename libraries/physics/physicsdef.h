...
/*!
 * \file physicsdef.h
 * \brief Physics struct definitions for the agent layer (header-only).
 * \ingroup cosmos_agent_physics
 *
 * Declares the C++ structs and enumerations (physicsstruc, attstruc, etc.)
 * used by the orbit propagator and spacecraft physics simulation. This is a
 * header-only type definition file with no corresponding implementation.
 */
