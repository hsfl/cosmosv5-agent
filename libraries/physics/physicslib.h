...
/*!
 * \file physicslib.h
 * \brief Orbital mechanics: SGP4, Gauss-Jackson propagator, and force models.
 * \ingroup cosmos_agent_physics
 * \defgroup cosmos_physicslib Physics Library
 *
 * Implements the core orbital mechanics algorithms: SGP4/SDP4 TLE propagation,
 * the variable-step Gauss-Jackson numerical integrator, and a suite of
 * perturbation force models (gravity, drag, solar pressure, third-body). Used
 * by simulatorclass and any agent that needs orbit prediction.
 */
