 ...
 * \brief Full spacecraft simulation environment with multiple bodies and time stepping.
 * \ingroup cosmos_agent_physics
 * \defgroup cosmos_simulatorclass Simulator Class
 *
 * Implements the top-level simulation environment that manages one or more
 * PhysicsClass instances, drives the shared simulation clock, handles
 * inter-body interactions, and publishes simulated telemetry into the COSMOS
 * namespace. Entry point for running hardware-in-the-loop and
