...
/*!
 * \file physicsclass.h
 * \brief Spacecraft physics simulation: attitude, power, thermal, and orbit.
 * \ingroup cosmos_agent_physics
 * \defgroup cosmos_physicsclass Physics Class
 *
 * Provides the PhysicsClass object that integrates attitude dynamics, power
 * budget, thermal model, and orbit propagation for a single spacecraft node.
 * Steps the full state forward in time and updates the COSMOS namespace
 * accordingly. Used by simulatorclass for multi-body scenarios.
 */
