...
/*!
 * \file gige_lib.h
 * \brief GigE Vision camera control and image acquisition.
 * \ingroup cosmos_agent_device
 * \defgroup cosmos_gigelib GigE Vision
 *
 * Provides discovery, configuration, and image-acquisition functions for GigE
 * Vision compliant cameras via the GenICam/GigE Vision protocol. Use with
 * imaging payloads that expose a standard GigE Vision interface.
 */
