...
/*!
 * \file acq_a35.h
 * \brief FLIR A35 thermal camera control via GigE Vision.
 * \ingroup cosmos_agent_device
 * \defgroup cosmos_acq_a35 ACQ A35
 *
 * Implements camera-specific control for the FLIR A35 uncooled thermal
 * imager on top of the GigE Vision transport (gige_lib). Provides NUC
 * (non-uniformity correction) triggering, scene statistics, and
