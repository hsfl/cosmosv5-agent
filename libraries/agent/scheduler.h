...
/*!
 * \file scheduler.h
 * \brief Time-based event scheduler for agent programs.
 * \ingroup cosmos_agent_framework
 * \defgroup cosmos_scheduler Scheduler
 *
 * Provides the Scheduler class that maintains a timeline of Events, fires them
 * at the correct MJD, and supports recurring (cron-style) triggers. Used by
 * agents that need to execute commands or state transitions at predetermined
 * or computed future times.
 */
