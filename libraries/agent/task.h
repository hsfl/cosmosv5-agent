...
/*!
 * \file task.h
 * \brief Asynchronous task execution with future/promise.
 * \ingroup cosmos_agent_framework
 * \defgroup cosmos_task Task
 *
 * Provides a lightweight Task wrapper around std::future/std::promise for
 * running operations asynchronously within an agent. Supports cancellation,
 * timeout, and chaining. Use to offload blocking I/O or computation without
 * blocking the agent's main request loop.
 */
